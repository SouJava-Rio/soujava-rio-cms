...
var SlideFormComponent = (function () {
    function SlideFormComponent(formBuilder, route, router, slideService) {
        ...
        this.slideForm = formBuilder.group({
            title: ['', [
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].minLength(30)
                ]],
            description: ['', [
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].minLength(100)
                ]]
        });
    }
    SlideFormComponent.prototype.ngOnInit = function () {
        ...
        this.slideForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormGroup */]({
        ...
        console.log(this.id);
        if (this.id) {
            this.slideService.findById(this.id).subscribe(function (ajaxMessageResponse) {
                _this.id = ajaxMessageResponse.data.id;
    ...
    SlideFormComponent.prototype.onSubmit = function () {
        ...
        if (this.slideForm.valid) {
            ...
            result.subscribe(function (data) { return _this.router.navigate(['slide']); });
...
SlideFormComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__slide_service__["a" /* SlideService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__slide_service__["a" /* SlideService */]) === "function" && _d || Object])
], SlideFormComponent);
...
var SlideListComponent = (function () {
    ...
    SlideListComponent.prototype.getAllSlides = function () {
        var _this = this;
        this.slideService.findAll().subscribe(function (listSlidesResponse) {
            _this.slides = listSlidesResponse.data;
        }, function (err) {
            console.log(err);
        });
    };
...
var routes = [
    { path: 'slide', component: __WEBPACK_IMPORTED_MODULE_2__slide_list_slide_list_component__["a" /* SlideListComponent */], pathMatch: 'full' },
